...
const About = () => {
    ...
    return (
        <div>
            ...
            <Box className={cls.gridContainer} component={Grid} container direction='row'  spacing='3' justifyContent='center' alignContent='center' >
                ...
                <Flip bottom cascade delay={900}>
                    ...
                    <Typography className={clsx(cls.text, cls.textAbout)}>
                        ...
                        I am interested in both the entire frontend and backend spectrum as well as working with positive people.
                    </Typography>
                    <Typography className={clsx(cls.text, cls.textAbout)}> 
                        Although currently inexperienced, I have done a few personal projects to showcase of what I can currently do.
                    </Typography>
                </Flip>
                </Grid>
