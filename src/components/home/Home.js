    ...
    <>
      <Box className={cls.container}>
        ...
        <Flip top cascade delay={1100}>
          <Typography className={clsx(cls.font)}>
            {Marwel} <span className={cls.spanned}>{Mancilla}</span>
          </Typography>
          <Box
            component={Typography}
            className={clsx(cls.NameMobile)}
            display='flex'
        ...
        <Flip bottom cascade delay={1200}>
          <Typography className={clsx(cls.font, cls.secondary)}>
            <span className={cls.spanned}>{web}</span> {developer}
          </Typography>
          <Box
            component={Typography}
            className={clsx(cls.JobMobile)}
            display='flex'
            flexDirection='column'
            alignItems='center'
          >
            <span className={cls.spanned}>
              {web} {developer}
            </span>
          </Box>
